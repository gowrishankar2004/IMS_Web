...
export default function AdmissionsPage() {
    ...
    return (
        <main ref={scrollRef} className="min-h-screen bg-transparent pt-28 pb-20">
            <section className="relative mx-auto max-w-4xl px-6">
                ...
                <div className="relative rounded-4xl border border-emerald-100 bg-white p-6 shadow-premium backdrop-blur-md sm:p-10">
                    {statusMessage ? (
                        <div
                    ...
                    >
                        ...
                        {category === "UG Courses" ? (
                            <div>
                                <RequiredLabel>Select College courses for coaching</RequiredLabel>
                                <div className="grid gap-3 sm:grid-cols-3">
